...
map="03-output/map.lod"$old_lod"_sizeLimit_"$old_sl".txt"     	#Initial LG map file. Typically generated by SeparateChromosomes or JoinSingles.
file="03-output/map_"$base"_trimmed_f.linkage"		#file [file2 ...]   Loads input genotypes in LINKAGE Pre-makeped format
